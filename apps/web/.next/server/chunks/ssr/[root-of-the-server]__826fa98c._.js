...
async function getCarFilters() {
    try {
        ...
        const makes = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].car.findMany({
            ...availableCars,
            distinct: [
                "make"
            ],
        ...
        const bodyTypes = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].car.findMany({
            ...availableCars,
            distinct: [
                "bodyType"
            ],
        ...
        const fuelTypes = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].car.findMany({
            ...availableCars,
            distinct: [
                "fuelType"
            ],
        ...
        const transmissions = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].car.findMany({
            ...availableCars,
            distinct: [
                "transmission"
            ],
        ...
        const priceRanges = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].saleInfo.aggregate({
            where: {
                status: "AVAILABLE"
            },
            _min: {
...
async function getCars({ search = "", make = "", bodyType = "", fuelType = "", transmission = "", minPrice = 0, maxPrice = 1000000000, sortBy = "newest", page = 1, limit = 10 }) {
    try {
        ...
        const dbUser = userId ? await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].user.findUnique({
            where: {
                clerkUserId: userId
            }
        }) : null;
        ...
        if (dbUser) {
            const saved = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].userSavedCar.findMany({
                where: {
                    userId: dbUser.id
                },
                select: {
...
async function toggleSavedCar(carId) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].userSavedCar.findUnique({
            where: {
                userId_carId: {
                    userId: user.id,
                    carId
        ...
        if (existing) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].userSavedCar.delete({
                where: {
                    userId_carId: {
                        userId: user.id,
                        carId
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].userSavedCar.create({
            data: {
                userId: user.id,
                carId
            }
...
async function getSavedCars() {
    try {
        ...
        if (!user) throw new Error("User not found");
        const savedCars = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].userSavedCar.findMany({
            where: {
                userId: user.id
            },
            include: {
...
async function getCarById(carId) {
    try {
        ...
        const wishlisted = dbUser ? !!await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].userSavedCar.findUnique({
            where: {
                userId_carId: {
                    userId: dbUser.id,
                    carId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__826fa98c._.js.map